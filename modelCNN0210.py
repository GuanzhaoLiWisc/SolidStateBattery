...
from keras.layers import Input,Dense, Conv3D, Flatten, MaxPooling3D, BatchNormalization, GlobalAveragePooling3D, LeakyReLU
...
pooling=MaxPooling3D(pool_size=(2, 2, 2), strides=None, padding='valid', data_format=None)(conv2) # maxPooling

flatten=Flatten()(pooling)  #flatten
featuremap=Dense(16, activation= "softmax")(flatten) # fully connected layer, output probablities
